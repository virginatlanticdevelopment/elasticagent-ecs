...
public class PluginRequest {
    ...
    public Agents listAgents() throws ServerRequestFailedException {
        DefaultGoApiRequest request = new DefaultGoApiRequest(Constants.REQUEST_SERVER_LIST_AGENTS, Constants.API_VERSION, Constants.PLUGIN_IDENTIFIER);
        GoApiResponse response = accessor.submit(request);
    ...
    public void disableAgents(Collection<Agent> toBeDisabled) throws ServerRequestFailedException {
        ...
        DefaultGoApiRequest request = new DefaultGoApiRequest(Constants.REQUEST_SERVER_DISABLE_AGENT, Constants.API_VERSION, Constants.PLUGIN_IDENTIFIER);
    ...
    public void deleteAgents(Collection<Agent> toBeDeleted) throws ServerRequestFailedException {
        ...
        DefaultGoApiRequest request = new DefaultGoApiRequest(Constants.REQUEST_SERVER_DELETE_AGENT, Constants.API_VERSION, Constants.PLUGIN_IDENTIFIER);
